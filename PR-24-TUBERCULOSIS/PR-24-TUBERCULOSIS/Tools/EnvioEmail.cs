...
namespace PR_24_TUBERCULOSIS.Tools
{
    class EnvioEmail
    {
        public bool EnvioGmail(string mail, string userName, string password)
        {
            ...
            string html = "<!DOCTYPE html> <html lang=\"en\"> <head> <meta charset=\"UTF-8\"> <meta http-equiv=\"X-UA-Compatible\" content=\"IE=edge\"> <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\"> <title>Document</title> </head> <body> <h1> Recuperacion de contraseña </h1><h3> Credenciales: </h3> <p>Nombre de Usuario: " + userName + " </p> <p>Contraseña: " + password + " </p> <p>Por seguridad no comparta su contraseña</p> </body> </html>";
